...
The log is replaced on every build. The TUI still needs an interactive terminal. Only compiler output is hidden, not the TUI itself. The current TUI closes during compilation and restarts after a successful build.
